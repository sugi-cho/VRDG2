...
namespace sugi.cc
{
    public class VRDG2OSCControll : MonoBehaviour
    {
        public static VRDG2OSCControll Instance { get { if (_Instance == null) _Instance = FindObjectOfType<VRDG2OSCControll>(); return _Instance; } }
        private static VRDG2OSCControll _Instance;
