...
namespace mattatz {
    ...
    public class CPBound {
        ...
        public CPBound(Vector3 p, Vector3 s, Vector3[] axes) {
            this.pos = p;
            this.size = s;
            this.axes = axes;
            ...
            this.structure = new CPBound_t(pos, size, Matrix4x4.identity);
        }
    ...
    public struct CPBound_t {
        public Vector3 pos;
        public Vector3 size;
        public Matrix4x4 TRS;
        public bool gravity;
        public CPBound_t(Vector3 p, Vector3 s, Matrix4x4 m) {
            pos = p;
            size = s;
            TRS = m;
            gravity = false;
